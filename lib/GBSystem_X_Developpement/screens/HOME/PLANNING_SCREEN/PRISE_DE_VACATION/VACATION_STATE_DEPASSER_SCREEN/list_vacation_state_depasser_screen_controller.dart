...
class ListVacationStateDepasserScreenController extends GetxController {
  ListVacationStateDepasserScreenController(this.context);
  BuildContext context;
  Rx<Color?> typeAbsColor = Rx<Color?>(GbsSystemStrings.str_primary_color);

  final vacationStateController =
      Get.put<GBSystemVacationStateDemanderController>(
