...
import 'package:portail_salarie/GBSystem_X_Developpement/screens/HOME/SELECT_ITEM_TYPE_DE_JOUR/GBSystem_select_item_typeJour_controller.dart';
...
class GBSystem_SelectItemTypeDeJourScreen extends StatelessWidget {
  const GBSystem_SelectItemTypeDeJourScreen(
      {super.key, required this.controllerTxtField});

  final TextEditingController controllerTxtField;
  @override
  Widget build(BuildContext context) {
    final GBSystemSelectItemTypeJourController m =
        Get.put(GBSystemSelectItemTypeJourController(context: context));
                            ...
                            ? Expanded(
                                child: ListView.builder(
                                  ...
                                  itemBuilder: (context, index) {
                                    return GBSystem_Root_CardView_TypeJour_Widget(
                                      tileColor: index % 2 == 0
                                      ...
                                      typeDeJour: m.filtredDocsOfficiel[index],
                                    );
                                  },
                                ),
                              )
                                ...
                                child: ListView.builder(
                                  ...
                                  itemBuilder: (context, index) {
                                    return GBSystem_Root_CardView_TypeJour_Widget(
                                      ...
                                      typeDeJour: m.docsOfficiel[index],
                                    );
                                  },
                                ),
                              )
