...
class UserEnterSortie extends StatefulWidget {
  UserEnterSortie(
      {super.key,
  ...
  @override
  State<UserEnterSortie> createState() => _UserEnterSortieState();
}

class _UserEnterSortieState extends State<UserEnterSortie>
