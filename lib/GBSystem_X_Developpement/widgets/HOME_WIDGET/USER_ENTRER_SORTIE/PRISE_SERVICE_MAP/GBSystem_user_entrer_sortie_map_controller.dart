...
class UserEntrerSortieMapController extends GetxController {
  BuildContext context;
  UserEntrerSortieMapController({required this.context});
  ...
  final GBSystemVacationMapController vacationController =
