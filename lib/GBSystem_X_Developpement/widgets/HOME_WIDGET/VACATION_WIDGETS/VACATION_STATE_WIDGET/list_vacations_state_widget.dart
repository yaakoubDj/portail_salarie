...
import 'package:portail_salarie/GBSystem_X_Developpement/widgets/HOME_WIDGET/VACATION_WIDGETS/VACATION_STATE_WIDGET/list_vacation_state_controller.dart';
import 'package:portail_salarie/_RessourceStrings/GBSystem_Application_Strings.dart';

class ListVacationStateWidget extends StatelessWidget {
  ListVacationStateWidget({
    super.key,
  ...
  Widget build(BuildContext context) {
    final m = Get.put<ListVacationStateWidgetController>(
        ListVacationStateWidgetController(context));
