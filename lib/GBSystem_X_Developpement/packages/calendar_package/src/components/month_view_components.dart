                          ...
                          child: Stack(
                            ...
                            children: [
                              Positioned(
                                ...
                                right: -8,
                                child: Visibility(
                                  visible: (events[index].event
                                              is EventModel) &&
                                          (events[index].event as EventModel)
                                                  .autre_agence ==
                                              "1"
                                      ? true
                                      : false,
...
class MonthPageHeader extends CalendarPageHeader {
  ...
  const MonthPageHeader({
    ...
    Color backgroundColor = GbsSystemServerStrings.str_primary_color,
    //  Constants.headerBackground,
  ...
  static String _monthStringBuilder(DateTime date, {DateTime? secondaryDate}) =>
      DateFormat.yMMMM(getLocaleApplication()).format(date);
